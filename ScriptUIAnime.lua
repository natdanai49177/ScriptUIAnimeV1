...
local Tabs = {
    ...
    Main = Window:AddTab('Main'), ['functions'] = Window:AddTab('functions'), ['UI Settings'] = Window:AddTab('UI Settings')
}
...
-- Functions Ui
local functionsGroup = Tabs['functions']:AddLeftGroupbox('Mic')
--hide name

functionsGroup:AddToggle('deleteName',{
    Text = 'Hide Name(DeleteName)',
    Default = true,
    Tooltip = 'Destroy Name on Head'
})
